import { Finding, Severity, ScanEvidence, ExploitEvidence, BolaIdentity } from "../src/types.js";
...
// Re-export the SSRF and evidence primitives so existing importers of
// scanner.js keep working after these moved to dedicated modules.
...
// (SSRF protection and evidence-bundle helpers now live in ./ssrf.js and
// ./evidence.js.)
