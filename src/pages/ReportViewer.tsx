                    ...
                    {(() => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {/* Legacy raw request/response drawer retired — the raw
                              exchange now lives inside the Exploit Receipt block above,
                              which carries the full request + response for every probe. */}
