...
**3/7 detected with real evidence (1 via a new detection capability, 2
already working with no fix needed), 4/7 confirmed as deliberate, documented
...
| T4-Price-Manip-001 (USD/MXN price) | ⛔ **Not detected — by design** | Same conclusion as Tier 2's T2-BizLogic-001, re-confirmed independently: proving it means completing a real checkout with real side effects. Not built. |
...
| 4 (Bilingual/Regional) | 3/7 | 4/7 | 1 |
